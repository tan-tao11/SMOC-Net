...
from src.utils.data_utils import crop_resize_by_warp_affine, get_2d_coord_np, read_image_mmcv, xyz_to_region
...
from src.utils.mask_utils import cocosegm2mask, get_edge

from .dataset_factory import register_datasets

from src.utils.smoc_utils import load_camera_pose
from src.utils.ssd_color_transform import ColorAugSSDTransform
...
class GDRN_Self_DatasetFromList(Base_DatasetFromList):
    ...
    def read_data(self, dataset_dict, idx):
        ...
        camera_path = osp.dirname(osp.dirname(dataset_dict["file_name"]))
        relatve_rot, relative_trans = load_camera_pose(camera_path, idx)
        dataset_dict["relative_rot"] = relatve_rot
        dataset_dict["relative_trans"] = relative_trans
