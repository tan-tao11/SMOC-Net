...
from src.utils.common import all_gather, get_world_size, is_main_process, synchronize
from src.utils.pysixd import inout, misc
from src.utils.pysixd.pose_error import te
            ...
            for i_in, _input in enumerate(inputs):
                for i_inst in range(len(_input["roi_img"])):
                    ...
                    if VIS:  # vis -----------------------------------------------------------
                        ...
                        # print(kpts3d_dict[str(cur_obj_id)].keys())
