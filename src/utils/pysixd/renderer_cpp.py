...
sys.path.append("/home/tantao/bop_renderer-master/build")
print(config.bop_renderer_path)
import bop_renderer
...
class RendererCpp(renderer.Renderer):
    ...
    def add_object(self, obj_id, model_path, **kwargs):
        ...
        NEEDS TO BE CALLED RIGHT AFTER CREATING THE RENDERER (this is
        due to some memory issues in the C++ renderer which need to be
        fixed).
        """
